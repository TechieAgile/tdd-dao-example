...
public interface ITddDaoExample {
	...
	<T> T getObject(String sqlQuery, RowMapper<T> rowMapper, Map<String, Object> map) throws ApplicationException;
	...
	int update(String sqlQuery, Object[] args, int[] types) throws ApplicationException;
