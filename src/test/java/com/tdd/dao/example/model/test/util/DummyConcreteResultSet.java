...
public class DummyConcreteResultSet extends DummyResultSet {
	/**
	 ...
	 */
	public DummyConcreteResultSet(String tableName, Collection<LinkedHashMap<String, String>> entries) {
